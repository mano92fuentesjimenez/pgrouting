...
pgr_createtopology_multimodal(jsonb,jsonb,jsonb,text,text,double precision)
...
pgr_euclideantsp(text,bigint,bigint,double precision,integer,integer,integer,double precision,double precision,double precision,boolean)
...
pgr_polyfill_jsonb_insert(jsonb,text[],jsonb)
pgr_polyfill_jsonb_object_insert_key(jsonb,text,jsonb)
pgr_polyfill_jsonb_object_set_key(jsonb,text,jsonb)
pgr_polyfill_jsonb_set(jsonb,text[],jsonb)
pgr_polyfill_json_object_insert_path(jsonb,text[],jsonb)
pgr_polyfill_json_object_set_path(jsonb,text[],jsonb)
